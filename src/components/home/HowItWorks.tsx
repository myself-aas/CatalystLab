    ...
    >
      <div className="relative z-10 ds-page-shell">
        <SectionHeader
          eyebrow={
            <>
              <Network className="size-3.5 text-[#F0FAFF]" />
        ...
        <div className="relative mt-12 md:mt-16">
          ...
          <div className="hidden md:block absolute top-[28px] left-8 right-8 h-[2px] bg-foreground/10 z-0">
            <motion.div
              className="h-full bg-gradient-to-r from-[#F0FAFF]/0 via-[#F0FAFF] to-[#F0FAFF]/0"
              initial={{ x: '-100%' }}
              whileInView={{ x: '100%' }}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="md:hidden mb-2 size-8 flex items-center justify-center rounded-lg bg-surface border border-foreground/10 text-foreground shadow-md">
                      <Icon className="size-4 text-[#F0FAFF]" />
                    </div>
                    ...
                    <div className="my-2 md:my-3">
                      <span className="text-emerald-400 font-mono text-xs bg-[#F0FAFF]/10 border border-emerald-500/20 px-2 py-0.5 rounded-full inline-block">
                        {step.time}
                      </span>
                    </div>
