      ...
      <div className="ds-page-shell">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          ...
          <div className="flex items-center gap-2 text-sm font-mono text-muted-foreground bg-background border border-border p-3 rounded-xl shadow-sm">
            <span className="w-2.5 h-2.5 rounded-full bg-[var(--accent-emerald-vital)] animate-ping" />
        ...
        <div className="relative">
          ...
          <motion.div 
            ...
            className="hidden lg:block absolute top-[40px] left-[12.5%] h-px bg-gradient-to-r from-[var(--accent-framer-blue)] via-[var(--accent-cyan-edge)] to-[var(--accent-emerald-vital)] -z-10 shadow-[0_0_10px_rgba(0,102,255,0.5)]" 
          />
                ...
                <LazyReveal key={step.number} direction="up" delay={idx * 0.1}>
                  <div className="relative flex items-start gap-4 lg:flex-col lg:items-center group">
                    ...
                    <div className="flex flex-col items-center shrink-0 lg:hidden pt-2">
                      <div className="w-2 h-2 rounded-full bg-foreground/20 group-hover:bg-[var(--accent-framer-blue)] transition-colors" />
                    ...
                    <div className="hidden lg:flex w-[80px] h-[80px] mx-auto bg-surface border border-border rounded-2xl items-center justify-center relative group-hover:border-foreground/30 transition-colors shadow-xl">
                      ...
                      <div className="absolute -bottom-3 left-1/2 -translate-x-1/2">
                        <span className="text-[var(--accent-emerald-vital)] font-mono text-xs bg-[var(--accent-emerald-vital)]/10 border border-[var(--accent-emerald-vital)]/20 px-2 py-0.5 rounded shadow-sm whitespace-nowrap">
                          {step.time}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex-1 min-w-0 lg:text-center lg:mt-6 space-y-2">
                      <h3 className="framer-card-title text-foreground">
                        <span className="text-[var(--accent-framer-blue)] mr-2 font-mono">{step.number}.</span>
                        {step.title.split(' (')[0]}
                      </h3>
                      <div className="lg:hidden mb-2">
                        <span className="text-[var(--accent-emerald-vital)] font-mono text-[10px] bg-[var(--accent-emerald-vital)]/10 border border-[var(--accent-emerald-vital)]/20 px-1.5 py-0.5 rounded">
                          {step.title.match(/\((.*?)\)/)?.[1]}
                        </span>
                      </div>
