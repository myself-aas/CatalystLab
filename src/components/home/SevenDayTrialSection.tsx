...
export const SevenDayTrialSection: React.FC = () => {
  ...
  const engineCards = [
    {
      ...
      bgClass: 'bg-white border-emerald-500/40 text-emerald-700',
      badge: 'Speed Index'
    },
    {
      id: 1,
      ...
      bgClass: 'bg-white border-slate-300 text-slate-800',
      badge: 'DNS & Latency'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      bgClass: 'bg-white border-rose-500/40 text-rose-700',
      badge: 'SecOps'
    },
    {
      id: 4,
      ...
      bgClass: 'bg-white border-amber-500/40 text-amber-700',
      badge: 'Eco Score'
    }
  ];
  ...
  return (
    <section 
      ...
      className="relative overflow-hidden bg-slate-50/70 backdrop-blur-sm py-16 sm:py-20 border-b border-slate-200 text-black"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <LazyReveal direction="left" className="lg:col-span-5 space-y-5">
            <div className="flex items-center gap-2">
              <span className="text-[11px] sm:text-xs font-mono font-bold tracking-[0.2em] text-slate-800 uppercase">
            ...
            <div className="pt-2 space-y-3">
              <div className="flex flex-wrap items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-black hover:bg-black-hover px-6 py-3 text-xs sm:text-sm font-mono font-bold text-white shadow-md active:scale-[0.98] transition-all cursor-pointer border border-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black"
                >
                ...
                <Link
                  to="/pricing"
                  className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 px-5 py-3 text-xs sm:text-sm font-mono font-semibold text-slate-700 hover:text-black transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black"
                >
                  <span>Compare Plans</span>
                  <ArrowRight className="h-3.5 w-3.5 text-slate-800" />
                </Link>
              </div>
            ...
            {/* Feature Checkpoints */}
            <div className="grid grid-cols-2 gap-2.5 pt-4 border-t border-slate-200 text-xs font-mono text-slate-600">
              <div className="flex items-center gap-2">
          ...
          <LazyReveal direction="right" className="lg:col-span-7 relative">
            <div className="relative min-h-[440px] sm:min-h-[480px] w-full rounded-2xl border border-slate-200 bg-white p-5 sm:p-7 shadow-xl overflow-hidden">
              
              {/* Header Info */}
              <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 pb-4 mb-5">
                <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-100 px-3 py-1 text-xs font-mono text-slate-600">
                ...
                <div className="flex items-center gap-2 bg-slate-100 px-3 py-1 rounded-full border border-slate-200 text-xs font-mono">
              ...
              {/* Schedule Preview */}
              <div className="w-full sm:w-[65%] rounded-xl border border-slate-200 bg-slate-100 p-3.5 mb-4 font-mono">
                ...
                <div className="space-y-1.5 text-[11px]">
                  <div className="flex items-center justify-between p-1.5 rounded bg-white border border-slate-200">
                    ...
                    <span className="text-emerald-700 font-bold">18ms TTFB</span>
                  </div>
                  <div className="flex items-center justify-between p-1.5 rounded bg-white border border-slate-200">
                    <span className="text-slate-500">12:00 PM • OWASP Transport</span>
                    <span className="text-slate-800 font-bold">Grade A+</span>
                  </div>
                  <div className="flex items-center justify-between p-1.5 rounded bg-white border border-slate-200">
                    <span className="text-slate-500">02:00 PM • AI Search RAG</span>
                    <span className="text-slate-800 font-bold">100% Ready</span>
                  </div>
                </div>
              </div>
                    ...
                    <button
                      ...
                      className={`shrink-0 rounded-xl p-3 text-left border transition-all cursor-pointer w-32 font-mono ${card.bgClass} ${
                        activeEngineCard === idx
                          ? 'ring-1 ring-black bg-slate-100'
                          : 'opacity-80 hover:opacity-100 bg-slate-100/70'
                      }`}
                    >
              ...
              {/* Bottom Tool Frame */}
              <div className="rounded-xl border border-slate-200 bg-slate-100 p-3 font-mono">
                <div className="flex gap-2.5">
                  <div className="flex flex-col gap-1 shrink-0 bg-white p-1 rounded-lg border border-slate-200">
                    <button
                      ...
                      className={`p-1.5 rounded text-xs transition-colors ${
                        activeToolTab === 'inspect' ? 'bg-black text-white' : 'text-slate-500 hover:text-black'
                      }`}
                    ...
                    <button
                      ...
                      className={`p-1.5 rounded text-xs transition-colors ${
                        activeToolTab === 'vitals' ? 'bg-black text-white' : 'text-slate-500 hover:text-black'
                      }`}
                      title="Core Web Vitals"
                    >
                    ...
                    <button
                      ...
                      className={`p-1.5 rounded text-xs transition-colors ${
                        activeToolTab === 'secops' ? 'bg-black text-white' : 'text-slate-500 hover:text-black'
                      }`}
                      title="SecOps"
                    >
                    ...
                    <button
                      ...
                      className={`p-1.5 rounded text-xs transition-colors ${
                        activeToolTab === 'api' ? 'bg-black text-white' : 'text-slate-500 hover:text-black'
                      }`}
                      title="API"
                    >
                  ...
                  <div className="flex-1 rounded-lg bg-white border border-slate-200 p-2.5 text-xs">
                    ...
                    <div className="grid grid-cols-3 gap-1.5 text-center">
                      <div className="bg-slate-100 p-1.5 rounded border border-slate-200">
                        <div className="text-[9px] text-slate-500">LCP</div>
                        <div className="text-xs font-bold text-emerald-600">0.74s</div>
                      </div>
                      <div className="bg-slate-100 p-1.5 rounded border border-slate-200">
                        <div className="text-[9px] text-slate-500">CLS</div>
                        <div className="text-xs font-bold text-emerald-600">0.001</div>
                      </div>
                      <div className="bg-slate-100 p-1.5 rounded border border-slate-200">
                        <div className="text-[9px] text-slate-500">QUOTA</div>
                        <div className="text-xs font-bold text-slate-800">5k/day</div>
                      </div>
                    </div>
                  </div>
                </div>
