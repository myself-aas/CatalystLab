...
export const Footer: React.FC = () => {
  ...
  return (
    <footer id="main-footer" className="relative z-20 border-t border-slate-800/80 bg-[#070b12] text-white">
      ...
      {/* =========================================================================
          GET IN TOUCH SECTION (Directly Above Bottom Navigation)
      ========================================================================= */}
      <div className="border-b border-[#415a77]/40 bg-gradient-to-r from-[#0d1b2a] via-[#0b192c] to-[#070b12] py-5 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3.5 text-center md:text-left">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#38bdf8]/15 text-[#38bdf8] border border-[#38bdf8]/30 shrink-0">
              <Mail className="h-5 w-5" />
            </div>
            <div>
              <div className="text-sm sm:text-base font-bold text-white flex items-center gap-2 justify-center md:justify-start">
                <span>Looking for Custom Audits or Enterprise Architecture Inquiries?</span>
                <span className="hidden sm:inline-block text-[10px] bg-[#34d399]/20 text-[#34d399] px-2 py-0.5 rounded font-mono font-bold">Live On-Call</span>
              </div>
              <p className="text-xs text-[#8ea8c3] mt-0.5">
                Connect with our core telemetry engineers, request white-labeling, or subscribe for automated performance alerts.
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2.5 shrink-0">
            <button
              type="button"
              onClick={() => openGetInTouchModal('general', 'footer-get-in-touch-banner')}
              className="inline-flex items-center gap-1.5 rounded-xl bg-[#c5d3e8] hover:bg-white text-[#0b192c] px-4 py-2.5 text-xs font-mono font-bold transition-all shadow-sm active:scale-95 cursor-pointer"
            >
              <Sparkles className="h-3.5 w-3.5 text-[#0b192c]" />
              <span>Get in Touch (Pop-up)</span>
            </button>
            <Link
              to="/contact"
              className="inline-flex items-center gap-1 rounded-xl border border-[#415a77]/60 bg-[#0b192c] hover:bg-[#162a45] text-slate-200 px-3.5 py-2.5 text-xs font-mono transition-all"
            >
      ...
      {/* Top Quick-Navigation Sitemap Strip */}
      <div className="border-b border-slate-800/60 bg-[#0a0f1a] py-3 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl flex flex-wrap items-center justify-between gap-3 text-xs font-mono">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-slate-300">
            ...
            <Link to="/products" className="hover:text-[#38bdf8] hover:underline transition-colors font-semibold text-[#38bdf8]">Products &amp; Plugins</Link>
            <span className="text-slate-700">|</span>
            <Link to="/docs" className="hover:text-white hover:underline transition-colors">Docs</Link>
            <span className="text-slate-700">|</span>
            <Link to="/api-docs" className="hover:text-white hover:underline transition-colors flex items-center gap-1">
              <span>API Reference</span>
            </Link>
            <span className="text-slate-700">|</span>
            <Link to="/playground" className="hover:text-white hover:underline transition-colors">Playground</Link>
            <span className="text-slate-700">|</span>
            ...
            <button
              type="button"
              onClick={() => openGetInTouchModal('general', 'footer-quick-nav')}
              className="text-[#38bdf8] hover:text-white hover:underline transition-colors flex items-center gap-1 cursor-pointer font-bold"
            >
