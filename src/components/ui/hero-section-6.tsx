    ...
    <div className={cn("relative", className)}>
      ...
      >
        ...
        <path
          ...
          className="fill-muted-foreground/60 dark:fill-muted-foreground"
        />
        {/* Side buttons */}
        <path
        ...
        <path
          ...
          className="fill-background dark:fill-muted-foreground"
        />
        <path
...
export default function HeroSection6() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-primary text-primary-foreground">
