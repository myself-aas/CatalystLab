    ...
    <aside className="w-full lg:w-72 shrink-0 space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-background p-4 shadow-sm">
        ...
        <nav className="space-y-1">
          ...
          <Link
            to="/playground"
            className="flex items-center justify-between rounded-xl px-3 py-2 text-sm font-semibold text-emerald-400 bg-[#F0FAFF]/10 hover:bg-[#F0FAFF]/20 border border-emerald-500/20 transition-colors mt-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
            <div className="flex items-center gap-2">
              <Terminal className="h-4 w-4 text-emerald-400" />
              <span>Interactive Playground</span>
            </div>
            <span className="text-[10px] font-bold uppercase px-1.5 py-0.5 rounded bg-[#F0FAFF]/20 text-emerald-300 border border-emerald-500/30">
              Live
            </span>
          </Link>
        </nav>
