  ...
  if (isTrialActive) {
    return (
      <div 
        ...
        className="w-full bg-gradient-to-r from-emerald-950/90 via-black to-indigo-950/90 border-b border-emerald-500/30 px-4 py-2 text-xs text-muted-foreground shadow-sm"
      >
