...
export const CustomIconShield: React.FC<IconProps> = ({ className = "h-4 w-4", size = 18, color = "currentColor", ...props }) => (
...
export const CustomIconSearch: React.FC<IconProps> = ({ className = "h-4 w-4", size = 18, color = "currentColor", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 -960 960 960" width={size} fill={color} className={className} {...props}>
...
export const CustomIconCode: React.FC<IconProps> = ({ className = "h-4 w-4", size = 18, color = "currentColor", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 -960 960 960" width={size} fill={color} className={className} {...props}>
...
export const CustomIconCodeAlt: React.FC<IconProps> = ({ className = "h-4 w-4", size = 18, color = "currentColor", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 -960 960 960" width={size} fill={color} className={className} {...props}>
    <path d="M240-280 40-480l200-200 56 56-143 144 143 144-56 56Zm178 132-76-24 200-640 76 24-200 640Zm302-132-56-56 143-144-143-144 56-56 200 200-200 200Z"/>
  </svg>
);
...
export const CustomIconGlobe: React.FC<IconProps> = ({ className = "h-4 w-4", size = 18, color = "currentColor", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 -960 960 960" width={size} fill={color} className={className} {...props}>
...
export const CustomIconUser: React.FC<IconProps> = ({ className = "h-4 w-4", size = 18, color = "currentColor", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 -960 960 960" width={size} fill={color} className={className} {...props}>
...
export const CustomIconEye: React.FC<IconProps> = ({ className = "h-4 w-4", size = 18, color = "currentColor", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 -960 960 960" width={size} fill={color} className={className} {...props}>
...
export const CustomIconCompass: React.FC<IconProps> = ({ className = "h-4 w-4", size = 18, color = "currentColor", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 -960 960 960" width={size} fill={color} className={className} {...props}>
...
export const CustomIconShieldAlt: React.FC<IconProps> = ({ className = "h-4 w-4", size = 18, color = "currentColor", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 -960 960 960" width={size} fill={color} className={className} {...props}>
...
export const CustomIconBadge: React.FC<IconProps> = ({ className = "h-4 w-4", size = 18, color = "currentColor", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 -960 960 960" width={size} fill={color} className={className} {...props}>
...
export const CustomIconSync: React.FC<IconProps> = ({ className = "h-4 w-4", size = 18, color = "currentColor", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 -960 960 960" width={size} fill={color} className={className} {...props}>
