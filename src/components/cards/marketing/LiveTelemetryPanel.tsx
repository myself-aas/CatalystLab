...
export const LiveTelemetryPanel: React.FC<LiveTelemetryPanelProps> = ({
  ...
  return (
    <Card
      ...
      className={twMerge(
        clsx(
          'relative w-full rounded-[24px] border border-white/15 bg-[#0B101D]/90 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col justify-between min-h-[460px]',
          className
        )
      )}
      {...props}
    >
      ...
      <div className="z-10 flex items-center justify-between p-4 sm:p-5 border-b border-white/10 bg-black/40 backdrop-blur-md">
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono font-bold text-xs sm:text-sm tracking-wider text-white uppercase flex items-center gap-1.5">
      ...
      <div className="z-10 px-4 sm:px-5 py-2.5 bg-black/30 border-b border-white/5 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Globe className="w-3.5 h-3.5 text-cyan-400" />
          <span className="text-xs font-mono text-slate-300">
            Target: <strong className="text-white">{activeDomain}</strong>
          </span>
        </div>
      ...
      <div className="z-10 p-4 sm:p-5 grid grid-cols-3 gap-2.5">
        <div className="p-3 rounded-xl bg-black/50 border border-white/10 backdrop-blur-md flex flex-col justify-between">
