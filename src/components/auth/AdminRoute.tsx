...
export const AdminRoute: React.FC<AdminRouteProps> = ({ children }) => {
  ...
  if (authLoading || (verifyingClaims && !claimCheckDone)) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-black">
        ...
        <div className="text-lg font-bold tracking-tight text-black">Verifying Superadmin Authorization</div>
  ...
  if (!user || !isAuthorized) {
    return (
      <div className="min-h-screen bg-white py-20 px-4 sm:px-6 text-black flex items-center justify-center">
        <div className="w-full max-w-lg rounded-3xl border border-[#415a77]/30 bg-white p-8 text-center shadow-2xl text-black">
          ...
          <p className="mt-3 text-xs sm:text-sm text-[#c5d3e8] leading-relaxed">
            The requested route <code className="text-cyan-300 font-mono bg-[#152238] px-1.5 py-0.5 rounded">{location.pathname}</code> is strictly restricted to accounts possessing the <span className="font-mono text-black font-semibold">superadmin</span> custom token claim.
          </p>
          ...
          <div className="mt-8 flex flex-col gap-3">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                to="/"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-[#415a77]/40 bg-[#152238] px-5 py-2.5 text-xs font-semibold text-black hover:bg-[#1e2f4a] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
              >
              ...
              {user ? (
                <div className="flex gap-2 w-full sm:w-auto">
                  <button
                    ...
                    className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 rounded-xl border border-[#415a77]/40 bg-[#152238] px-3.5 py-2.5 text-xs font-semibold text-[#c5d3e8] hover:text-black transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 rounded-xl bg-[#415a77] px-5 py-2.5 text-xs font-bold text-black hover:bg-[#52718e] transition-all shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
                  >
                ...
                <button
                  onClick={() => login()}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-[#415a77] px-5 py-2.5 text-xs font-bold text-black hover:bg-[#52718e] transition-all shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
                >
                  <LogIn className="h-3.5 w-3.5" />
            ...
            <div className="pt-4 border-t border-[#415a77]/30 flex flex-col sm:flex-row items-center justify-center gap-2">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-emerald-500/40 bg-emerald-950/30 px-4 py-2 text-xs font-bold text-emerald-300 hover:bg-emerald-900/40 transition-all shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 rounded-xl border border-[#415a77]/30 bg-[#152238] px-3.5 py-2 text-xs font-semibold text-[#c5d3e8] hover:text-black transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
              >
