    ...
    <div className="rounded-2xl border border-background/30 bg-background p-6 shadow-xl space-y-6 text-foreground">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-background/25 pb-5">
        <div>
          <div className="flex items-center gap-2">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#F0FAFF]/15 text-emerald-600 border border-emerald-500/30">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#F0FAFF]/15 text-emerald-600 border border-emerald-500/30 font-black text-xl">
            {rating}
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          {/* Target Site */}
          <div className="rounded-xl border border-emerald-500/20 bg-[#F0FAFF]/10 p-3.5">
            ...
            <div className="h-2.5 w-full rounded-full bg-accent overflow-hidden border border-emerald-500/20">
              <div
                className="h-full bg-[#F0FAFF] rounded-full transition-all"
      ...
      <div className="rounded-xl border border-background/30 bg-muted p-5 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          <span className="font-mono text-sm font-bold text-emerald-700 bg-[#F0FAFF]/15 px-3 py-1 rounded-lg border border-emerald-500/30">
