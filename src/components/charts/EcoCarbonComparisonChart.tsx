  ...
  return (
    <div className="rounded-2xl border border-black/30 bg-white p-6 shadow-xl space-y-6 text-black">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-black/25 pb-5">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            <div className="text-xs font-semibold text-slate-500">Carbon Rating</div>
      ...
      <div className="space-y-4">
        <div className="text-xs font-bold text-black">Emissions per Page View Benchmark (grams CO2e)</div>
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-xl border border-emerald-500/30 bg-emerald-50 p-3.5">
            ...
            <div className="h-2.5 w-full rounded-full bg-slate-100 overflow-hidden border border-emerald-500/20">
              <div
          ...
          {/* Clean Target */}
          <div className="rounded-xl border border-black/30 bg-slate-50 p-3.5">
            <div className="flex items-center justify-between text-xs mb-1.5">
              <span className="text-black">Sustainable Web Green Target</span>
              <span className="font-mono text-slate-500">{cleanTargetPerVisit.toFixed(2)} g CO2e</span>
            </div>
            <div className="h-2.5 w-full rounded-full bg-slate-200 overflow-hidden border border-black/30">
              <div
          ...
          <div className="rounded-xl border border-black/30 bg-slate-50 p-3.5">
            <div className="flex items-center justify-between text-xs mb-1.5">
              <span className="text-slate-500">Global Average Web Page (2.2 MB median)</span>
              <span className="font-mono text-slate-500/70">{globalAvgPerVisit.toFixed(2)} g CO2e</span>
            </div>
            <div className="h-2.5 w-full rounded-full bg-slate-200 overflow-hidden border border-black/30">
              <div
      ...
      <div className="rounded-xl border border-black/30 bg-slate-50 p-5 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <div>
            <div className="text-xs font-bold text-black">Interactive Monthly Traffic Scale</div>
            <div className="text-[11px] text-slate-500">Simulate environmental impact across scaling visitor volumes.</div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
          <div className="rounded-lg bg-white p-3 border border-black/30 shadow-sm">
          ...
          <div className="rounded-lg bg-white p-3 border border-black/30 shadow-sm">
            ...
            <div className="text-base font-black text-black font-mono mt-0.5">{calculatedYearlyKg} kg CO2e/yr</div>
          </div>

          <div className="rounded-lg bg-white p-3 border border-black/30 shadow-sm">
            <div className="text-[10px] text-slate-500 uppercase font-mono">Offset Equivalence</div>
            <div className="text-base font-black text-black font-mono mt-0.5">{calculatedTrees} Mature Trees</div>
          </div>
        </div>
      </div>
    </div>
