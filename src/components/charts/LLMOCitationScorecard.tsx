  ...
  return (
    <div className="rounded-2xl border border-black/30 bg-white p-6 shadow-xl space-y-6 text-black">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-black/25 pb-5">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            <div className="text-xs font-semibold text-slate-500">LLMO Index</div>
            <div className="text-xl font-black text-black font-mono">{score}/100</div>
          </div>
          <div className="rounded-xl px-3 py-1.5 text-xs font-bold border border-black/40 bg-black/25 text-black">
            {citationConfidence}
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="rounded-xl border border-black/30 bg-slate-50 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Code className="h-4 w-4 text-black" />
              <span className="text-xs font-bold text-black">JSON-LD Structured Markup</span>
            </div>
            {jsonLdBlocksCount > 0 ? (
              ...
              <span className="text-[11px] font-mono font-bold text-slate-500 bg-slate-200 px-2 py-0.5 rounded border border-slate-300">
                MISSING
              </span>
            )}
          </div>
        ...
        <div className="rounded-xl border border-black/30 bg-slate-50 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-black">OpenGraph & Social Entity Graph</span>
            </div>
            {hasOgTags ? (
              <span className="text-[11px] font-mono font-bold text-emerald-600 bg-emerald-500/15 px-2 py-0.5 rounded border border-emerald-500/30">
                PASS
        ...
        <div className="rounded-xl border border-black/30 bg-slate-50 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-black">Canonical URL Authority</span>
            </div>
            {hasCanonical ? (
              <span className="text-[11px] font-mono font-bold text-emerald-600 bg-emerald-500/15 px-2 py-0.5 rounded border border-emerald-500/30">
                VERIFIED
        ...
        <div className="rounded-xl border border-black/30 bg-slate-50 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-black">AI Search Citation Probability</span>
            </div>
            <span className="text-[11px] font-mono font-bold text-black bg-black/25 px-2 py-0.5 rounded border border-black/40">
