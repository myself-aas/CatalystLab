...
header {
  ...
  return (
    <div className="rounded-2xl border border-background/30 bg-background p-6 shadow-xl space-y-6 text-foreground">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-background/25 pb-5">
        <div>
          <div className="flex items-center gap-2">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-foreground/25 text-muted-foreground border border-background/40">
      ...
      <div className="overflow-x-auto scrollbar-none touch-pan-x rounded-xl border border-background/30 bg-background">
        <table className="w-full text-left text-xs">
          <thead className="border-b border-background/25 bg-background font-semibold text-muted-foreground">
            <tr>
      ...
      {/* Remediation Snippet */}
      <div className="rounded-xl border border-background/30 bg-background p-4 space-y-3">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center rounded-lg bg-background p-0.5 border border-background/30 text-[11px]">
              <button
            ...
            <button
              onClick={handleCopy}
              className="flex items-center gap-1.5 rounded-lg border border-background/40 bg-foreground/25 px-3 py-1 text-xs font-semibold text-foreground hover:bg-foreground/40 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
        ...
        <pre className="overflow-x-auto scrollbar-none touch-pan-x rounded-lg bg-background p-3.5 font-mono text-[11px] text-muted-foreground border border-background/30">
