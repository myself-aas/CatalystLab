...
export const RateLimitThresholdAlert: React.FC<RateLimitThresholdAlertProps> = ({
  ...
  if (status.isUnlimited || isAdmin) {
    ...
    return (
      <div className={`rounded-xl border border-[#415a77]/40 bg-[#0b192c]/90 px-4 py-3 text-xs text-[#f8fafc] backdrop-blur-md shadow-sm ${className}`}>
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2.5">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#415a77]/30 text-[#38bdf8] border border-[#38bdf8]/30">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#c5d3e8] mt-0.5">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-start gap-3.5">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-[#c5d3e8] leading-relaxed max-w-2xl">
  ...
  if (isApproaching) {
    if (compact) {
      return (
        <div className={`inline-flex items-center gap-2 rounded-lg border border-amber-500/50 bg-amber-950/40 px-3 py-1.5 text-xs text-amber-200 font-mono ${className}`}>
          ...
          <span className="text-[10px] text-amber-300 border-l border-amber-500/30 pl-2">
            Resets in {status.formattedResetTime}
          </span>
        </div>
      );
    ...
    return (
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-start gap-3.5">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-amber-500/50 bg-amber-500/20 text-amber-300 shadow-inner">
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="rounded-md border border-amber-500/40 bg-amber-500/20 px-2 py-0.5 text-[11px] font-mono font-bold text-amber-200">
              ...
              <div className="mt-3 max-w-md">
                <div className="h-2 w-full overflow-hidden rounded-full bg-[#152238] border border-[#415a77]/30">
                  <div 
                ...
                <div className="mt-1 flex items-center justify-between text-[10px] font-mono text-[#8ea8c3]">
                  ...
                  <span className="text-amber-300 font-bold">{remaining} units remaining</span>
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <div className={`rounded-xl border border-[#415a77]/30 bg-[#0d1b2a]/80 p-3.5 text-[#f8fafc] backdrop-blur-md shadow-sm ${className}`}>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-[#f8fafc]">{status.tierLabel} Quota Allocation</span>
