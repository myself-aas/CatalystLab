...
export const PerfWidget = () => (
  <div className="flex flex-col gap-4 w-full h-full relative p-4">
    <div className="flex items-center justify-between">
      <span className="text-[11px] font-mono text-[#666666] uppercase">Core Web Vitals</span>
    ...
    <div className="grid grid-cols-3 gap-2 flex-1 mt-2">
      {[
        ...
        <div key={m.label} className="bg-white/5 rounded-lg flex flex-col items-center justify-center gap-1 border border-white/5 relative overflow-hidden">
          ...
          <span className="text-[#666666] text-[10px] font-mono">{m.label}</span>
        </div>
      ))}
    </div>
    <div className="h-10 mt-auto bg-black rounded-lg border border-white/10 flex items-center px-3 overflow-hidden relative">
      <motion.div 
...
export const LatencyWidget = () => (
  <div className="flex flex-col gap-3 w-full h-full relative p-4">
    <div className="flex items-center justify-between">
      <span className="text-[11px] font-mono text-[#666666] uppercase">Edge PoP Matrix</span>
    ...
    <div className="flex-1 flex flex-col gap-2 mt-2">
      {[
        ...
        <div key={r.reg} className="flex items-center justify-between text-xs font-mono">
          <span className="text-[#999999]">{r.reg}</span>
...
export const EcoWidget = () => (
  <div className="flex flex-col items-center justify-center gap-4 w-full h-full p-4 relative">
    <div className="absolute top-4 left-4 right-4 flex justify-between">
       <span className="text-[11px] font-mono text-[#666666] uppercase">Carbon Budget</span>
    </div>
    <div className="relative size-24 mt-4">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className="text-[9px] font-mono text-[#999999]">CO2e</span>
      </div>
    </div>
...
export const SecurityWidget = () => (
  <div className="flex flex-col w-full h-full p-0 font-mono text-xs overflow-hidden relative border border-white/5 rounded-lg bg-black">
    <div className="flex items-center gap-2 px-3 py-2 bg-white/5 border-b border-white/10 text-[#666666]">
      <ShieldCheck className="size-3" /> OWASP Sniffer
    </div>
    <div className="p-3 flex flex-col gap-1.5 text-[#00D2FF]">
      <div><span className="text-[#999999]">&gt;</span> Checking Strict-Transport-Security... <span className="text-emerald-400">OK</span></div>
      <div><span className="text-[#999999]">&gt;</span> Checking X-Frame-Options... <span className="text-emerald-400">DENY</span></div>
      <div><span className="text-[#999999]">&gt;</span> Checking Content-Security-Policy...</div>
...
export const AiWidget = () => (
  <div className="flex flex-col w-full h-full p-4 relative font-mono text-xs">
    <div className="flex items-center justify-between mb-4">
      <span className="text-[#666666] uppercase text-[11px]">/llms.txt Parser</span>
      <Cpu className="size-3 text-[#8A2BE2]" />
    </div>
    <div className="bg-black border border-white/10 rounded p-3 flex-1 overflow-hidden relative">
...
export const MigrationWidget = () => (
  <div className="flex flex-col w-full h-full relative p-0 overflow-hidden rounded-lg border border-white/5 bg-[#050505]">
    <div className="flex gap-4 px-4 py-2 text-[10px] font-mono border-b border-white/10 bg-white/5">
       <span className="text-white border-b-2 border-white pb-1">Payload</span>
       <span className="text-[#666666]">AST Diff</span>
    </div>
    <div className="p-4 flex-1 text-xs font-mono text-[#999999] flex flex-col gap-1">
...
export const RepoWidget = () => (
  <div className="flex flex-col w-full h-full p-4 relative">
    <div className="flex items-center gap-2 mb-4 text-[#666666] font-mono text-[11px] uppercase">
      <GitBranch className="size-3" /> Commit Tree
    </div>
    <div className="flex flex-col gap-3 relative pl-4 border-l border-white/10 ml-2">
      <div className="relative">
        ...
        <p className="text-[10px] text-[#999999] font-mono mt-0.5">7a9f8b2 • 2m ago</p>
      </div>
      <div className="relative opacity-50">
        ...
        <p className="text-[10px] text-[#999999] font-mono mt-0.5">b43a1c9 • 1h ago</p>
      </div>
    </div>
  </div>
);
...
export const LlmoWidget = () => (
  <div className="flex flex-col items-center justify-center gap-4 w-full h-full p-4 relative">
     <div className="absolute top-4 left-4 flex items-center gap-2 text-[#666666] font-mono text-[11px] uppercase">
      <Search className="size-3" /> Discoverability
    </div>
    <div className="text-4xl font-semibold text-white tracking-tight mt-6">
      98<span className="text-lg text-[#666666]">/100</span>
    </div>
