    ...
    <div className="grid grid-cols-3 gap-2 flex-1 mt-2">
      {[
        ...
        <div key={m.label} className="bg-[var(--bg-surface)] rounded-lg flex flex-col items-center justify-center gap-1 border border-foreground/5 relative overflow-hidden">
          ...
          <span className="text-foreground font-mono text-sm">{m.val}</span>
  ...
  <div className="flex flex-col items-center justify-center gap-4 w-full h-full p-4 relative">
    ...
    <div className="relative size-24 mt-4">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span className="text-sm font-semibold text-foreground">0.12g</span>
...
export const SecurityWidget = () => (
  <div className="flex flex-col w-full h-full p-0 font-mono text-xs overflow-hidden relative border border-foreground/5 rounded-lg bg-background">
    ...
    <div className="p-3 flex flex-col gap-1.5 text-[var(--accent-cyan-edge)]">
      ...
      <motion.div 
        ...
        className="mt-2 w-2 h-3 bg-foreground"
      />
    </div>
  </div>
);
...
export const MigrationWidget = () => (
  <div className="flex flex-col w-full h-full relative p-0 overflow-hidden rounded-lg border border-foreground/5 bg-background">
    <div className="flex gap-4 px-4 py-2 text-[10px] font-mono border-b border-border bg-[var(--bg-surface)]">
       <span className="text-foreground border-b-2 border-foreground pb-1">Payload</span>
