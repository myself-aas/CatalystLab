...
export const SignUpPage: React.FC = () => {
 ...
 className="flex items-center justify-center gap-2 rounded-xl border border-border bg-accent .5 px-5 py-2.5 text-xs font-mono font-bold text-foreground transition-colors hover:bg-muted disabled:opacity-60 cursor-pointer shadow-sm"
 >
 {authMethod === 'google' ? (
 ...
 } pl-9 pr-3.5 px-4 py-2 text-xs font-mono text-foreground placeholder:text-muted-foreground focus:border-amber-500 focus:outline-none transition-colors`}
 />
 </div>
 ...
 className="ds-card w-full text-center font-mono text-[11px] font-bold text-muted-foreground ds-card-interactive p-4"
 >
