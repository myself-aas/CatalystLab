...
export const SignUpPage: React.FC = () => {
 ...
 className="mt-1 font-bold underline text-rose-300 hover:text-foreground cursor-pointer text-[11px]"
 >
 ...
 required
 className="ds-input pl-9 bg-background border-border text-foreground placeholder-neutral-600 focus:border-primary focus:ring-primary"
 />
 ...
 className="ds-input pl-9 bg-background border-border text-foreground placeholder-neutral-600 focus:border-primary focus:ring-primary font-mono"
 />
 ...
 required
 className="ds-input pl-9 pr-9 bg-background border-border text-foreground placeholder-neutral-600 focus:border-primary focus:ring-primary font-mono"
 />
