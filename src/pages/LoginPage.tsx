...
export const LoginPage: React.FC = () => {
 ...
 return (
 <div data-theme="dark" className="relative min-h-screen ds-page-top flex flex-col items-center px-4 bg-background text-foreground">
 <SEOHead
 ...
 {activeErrorMessage && (
 <div className="mb-5 rounded-xl border border-rose-500/30 bg-[#F7FDFF]/10 p-3.5 text-xs text-rose-300">
 ...
 className="font-bold underline text-rose-300 hover:text-foreground cursor-pointer text-[11px]"
 >
 ...
 <div className="mb-5 rounded-xl border border-emerald-500/30 bg-[#F0FAFF]/10 p-3.5 text-xs text-emerald-200 flex items-start gap-2">
 ...
 required
 className="ds-input pl-10 bg-background border-border text-foreground placeholder-neutral-600 focus:border-primary focus:ring-primary"
 />
 ...
 placeholder="••••••••••••"
 required
 className="ds-input pl-10 pr-10 bg-background border-border text-foreground placeholder-neutral-600 focus:border-primary focus:ring-primary font-mono"
 />
 ...
 className="rounded bg-background border-border-strong text-[#F0FAFF] focus:ring-0 focus:ring-offset-0 size-3.5"
 />
 ...
 type="submit"
 disabled={isSubmitting}
 className="ds-btn w-full bg-foreground text-background hover:bg-neutral-200 text-xs sm:text-sm shadow-[0_0_24px_rgba(255,255,255,0.25)] active:scale-[0.98] mt-2"
 >
 {authMethod === 'email' ? (
 <>
 <RotateCw className="size-4 animate-spin text-background" />
 ...
 className="px-2 py-1 rounded bg-[#F0FAFF]/10 border border-amber-500/30 text-amber-300 hover:bg-[#F0FAFF]/20 transition-all font-mono"
 >
 Superadmin
 </button>
 <button
 ...
 className="px-2 py-1 rounded bg-[#F0FAFF]/10 border border-blue-500/30 text-blue-300 hover:bg-[#F0FAFF]/20 transition-all font-mono"
 >
 Team Pro
 </button>
 </div>
 ...
 <Link to="/signup" className="text-foreground hover:text-[#F0FAFF] font-medium transition-colors">
