...
export const LoginPage: React.FC = () => {
 ...
 return (
 <div className="relative flex min-h-[calc(100vh-140px)] flex-col justify-center overflow-hidden bg-transparent py-12 text-foreground sm:px-6 lg:px-8">
 <SEOHead
 ...
 <div className="sm:mx-auto sm:w-full sm:ds-page-shell relative z-10">
 {/* Brand Logo & Header */}
 ...
 {/* Card Container */}
 <div className="ds-card p-6 shadow-linear-card sm:p-8">
 ...
 className="ds-card flex items-center gap-2 text-xs font-mono font-bold ds-card-interactive p-4"
 >
 {authMethod === 'google' ? (
 ...
 <span className="bg-background text-[10px] font-mono font-semibold text-muted-foreground uppercase tracking-wider">
 ...
 <label htmlFor="password"className="block text-xs font-mono font-bold text-muted-foreground">
 Password
 </label>
 <button
 type="button"
 onClick={() => setIsResetMode(true)}
 className="text-xs font-mono text-foreground hover:underline cursor-pointer font-bold"
 >
 Forgot password?
 </button>
 </div>
 ...
 className="h-3.5 w-3.5 rounded border-border bg-muted text-foreground focus:ring-0"
 />
 ...
 type="submit"
 disabled={isSubmitting}
 className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary hover:bg-primary-hover border border-border px-5 py-2.5 text-xs font-mono font-bold text-primary-foreground shadow-sm transition-all disabled:opacity-60 cursor-pointer"
 >
 ...
 <div>
 <label htmlFor="reset-email"className="block text-xs font-mono font-bold text-muted-foreground mb-1">
 ...
 className="ds-card text-center text-[11px] font-bold text-muted-foreground ds-card-interactive p-4"
 >
 Dev User Preview
 </button>
 <button
