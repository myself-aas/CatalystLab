...
export const SecurityPage: React.FC = () => {
 ...
 className="inline-flex items-center gap-2 rounded-xl bg-primary hover:bg-primary-hover border border-border px-6 py-3 text-xs sm:text-sm font-bold text-primary-foreground transition-all shadow-sm active:scale-95"
 >
