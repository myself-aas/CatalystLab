          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm font-semibold text-gray-800 shadow-sm hover:bg-gray-50 hover:border-gray-400 transition-all cursor-pointer"
              >
              ...
              <Link
                to="/playground"
                className="inline-flex items-center gap-2 rounded-xl bg-[#0b192c] px-4 py-2.5 text-sm font-bold text-white shadow-md hover:bg-[#152238] transition-all"
              >
                ...
                {API_CATEGORIES.map((cat) => {
                  ...
                  return (
                    <Link
                      ...
                      className="group rounded-2xl border border-[#e2e8f0] bg-white p-5 shadow-sm hover:shadow-md hover:border-[#415a77]/40 transition-all flex flex-col justify-between"
                    >
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <ChevronRight className="h-4 w-4 text-gray-400 group-hover:text-[#0b192c] group-hover:translate-x-0.5 transition-all" />
                        </div>
              ...
              <div className="space-y-3">
                {filteredEndpoints.map((ep) => {
                  ...
                  return (
                    <div
                      key={ep.id}
                      className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-2xl border border-gray-200 bg-gray-50/50 p-4 hover:bg-white hover:border-[#415a77]/30 hover:shadow-sm transition-all"
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                        <Link
                          ...
                          className="inline-flex items-center gap-1.5 rounded-xl border border-gray-300 bg-white px-3 py-1.5 text-xs font-semibold text-gray-800 hover:bg-gray-50 transition-colors"
                        >
                          <span>Spec</span>
                        ...
                        {ep.engineId && (
                          <Link
                            ...
                            className="inline-flex items-center gap-1.5 rounded-xl bg-[#0b192c] px-3 py-1.5 text-xs font-bold text-white hover:bg-[#152238] transition-colors"
                          >
