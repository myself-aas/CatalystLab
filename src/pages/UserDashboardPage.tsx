...
export const UserDashboardPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'audits' | 'blogs'>('audits');
        ...
        <div className="mb-8 border-b border-[#e2e8f0]">
          <nav className="-mb-px flex space-x-8" aria-label="Tabs">
            <button
              ...
              className={`whitespace-nowrap border-b-2 py-4 px-1 text-sm font-bold flex items-center gap-2 ${
                activeTab === 'audits'
                  ? 'border-[#0b192c] text-[#0b192c]'
                  : 'border-transparent text-[#415a77] hover:border-[#415a77]/30 hover:text-[#0b192c]'
              }`}
            >
