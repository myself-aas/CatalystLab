...
export default {
 ...
 <p className="text-sm text-muted-foreground font-sans max-w-3xl mx-auto leading-relaxed">
 ...
 <p className="text-sm text-muted-foreground mt-2 max-w-3xl mx-auto font-sans leading-relaxed">
 ...
 <span className="text-[10px] font-mono font-bold bg-muted text-muted-foreground border border-border .5 py-1 rounded-lg">
 Automated Cron
 </span>
 </div>
 ...
 <a
 href="#domain-configurator"
 className="inline-flex items-center gap-1.5 text-xs font-bold font-sans text-foreground hover:underline px-4 py-2"
 >
 ...
 className="ds-card w-full text-sm font-mono p-4"
 />
 </div>
 ...
 className="ds-card w-full text-xs font-mono p-4"
 />
 )}
 </div>
 ...
 className="ds-card flex items-center gap-1.5 text-muted-foreground text-xs font-sans font-medium ds-card-interactive p-4"
 >
 ...
 {/* GitHub Action */}
 <div className="ds-card p-6 flex flex-col">
 <div>
 ...
 className="flex items-center gap-1px-2.5 py-1.5 rounded-lg bg-muted hover:bg-accent text-xs font-sans font-medium text-muted-foreground border border-border cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
 >
 ...
 <Link
 to="/pricing"
 className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-background hover:bg-accent text-foreground font-sans font-bold py-3 text-sm transition-all shadow-sm active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
 >
 ...
 <Link
 to="/contact"
 className="ds-card w-full items-center gap-2 text-primary-foreground text-sm font-sans font-semibold ds-card-interactive p-4"
 >
