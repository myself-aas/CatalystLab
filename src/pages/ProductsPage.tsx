...
export default {
  ...
  return (
    <div className="min-h-screen bg-white text-black pb-24 selection:bg-black/40 selection:text-white">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-slate-50 text-black py-16 px-4 sm:px-6 lg:px-8 border-b border-slate-200">
        <div className="relative mx-auto max-w-7xl">
          <div className="flex flex-wrap items-center gap-2 mb-4">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-mono text-slate-600">
              <Radio className="h-3.5 w-3.5 text-slate-900 animate-pulse" />
              <span>Products &amp; Continuous Telemetry</span>
            </span>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-mono text-emerald-700 font-bold">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a 
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-black hover:bg-slate-800 text-white px-5 py-2.5 text-xs sm:text-sm font-mono font-bold transition-all shadow-md active:scale-95 border border-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-100 text-slate-600 hover:text-black px-5 py-2.5 text-xs sm:text-sm font-mono transition-all shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900"
            >
            ...
            <Link
              to="/api-docs"
              className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 hover:border-slate-300 text-slate-500 hover:text-black px-4 py-2.5 text-xs sm:text-sm font-mono transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900"
            >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 space-y-14">
        ...
        <section>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
            <div>
              <div className="text-xs font-mono font-bold uppercase tracking-wider text-slate-500 flex items-center gap-1.5 mb-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            {(selectedCategory === 'all' || selectedCategory === 'monitoring') && (
              <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 shadow-lg hover:border-slate-300 transition-all">
                <div>
                  <div className="flex items-center justify-between gap-2 mb-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-50 text-slate-800 border border-slate-200">
                      <Radio className="h-5 w-5" />
                    </div>
                    <span className="text-[10px] font-mono font-bold bg-slate-100 text-slate-800 border border-slate-300 px-2 py-0.5 rounded-md">
                      Automated Cron
                    </span>
                  </div>
                ...
                <div className="mt-6 pt-4 border-t border-slate-200 flex items-center justify-between">
                  ...
                  <a
                    href="#domain-configurator"
                    className="inline-flex items-center gap-1 text-xs font-bold font-mono text-slate-900 hover:underline"
                  >
            ...
            {(selectedCategory === 'all' || selectedCategory === 'cicd') && (
              <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 shadow-lg hover:border-slate-300 transition-all">
                <div>
                  <div className="flex items-center justify-between gap-2 mb-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-50 text-amber-600 border border-slate-200">
        ...
        <section id="domain-configurator" className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-xl">
          <div className="max-w-3xl mb-8">
            <div className="inline-flex items-center gap-1.5 rounded-full bg-slate-50 border border-slate-200 text-slate-600 px-3 py-1 text-xs font-mono mb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 pl-10 pr-4 py-2.5 text-sm font-mono text-black placeholder:text-slate-400 focus:border-slate-300 focus:outline-none transition-all"
                  />
                </div>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center justify-center rounded-xl p-2.5 border text-center transition-all cursor-pointer ${
                        frequency === item.id 
                          ? 'border-slate-300 bg-black text-white shadow-md' 
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {[
                    ...
                    return (
                      ...
                      >
                        <Icon className={`h-4 w-4 shrink-0 ${isEnabled ? 'text-slate-900' : 'text-slate-500'}`} />
              ...
              <div>
                      ...
                      <button
                        ...
                        className={`flex items-center justify-center gap-1.5 p-2 rounded-xl border text-xs font-mono font-semibold transition-all cursor-pointer ${
                          alertChannel === item.id
                            ? 'border-slate-300 bg-black text-white'
                            : 'border-slate-200 bg-slate-50 text-slate-600 hover:bg-slate-100 hover:text-black'
                        }`}
                      >
                ...
                {alertChannel === 'webhook' && (
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-mono text-black focus:border-slate-300 focus:outline-none"
                  />
                )}
              </div>
            ...
            <div className="lg:col-span-6 flex flex-col h-full rounded-2xl border border-slate-200 bg-slate-50 text-black p-5 shadow-inner">
              <div className="flex items-center justify-between pb-2.5 border-b border-slate-200 mb-3">
                <div className="flex items-center gap-2">
                  <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                  <span className="text-xs font-mono font-bold text-slate-600">catalystlab-config.json</span>
                </div>
                <button
                  onClick={() => copyToClipboard(generateConfigJson(), 'config-json')}
                  className="flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white hover:bg-slate-100 text-slate-600 hover:text-black px-2.5 py-1 text-xs font-mono transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900"
                >
              ...
              {/* Code display */}
              <pre className="flex-1 overflow-x-auto text-xs font-mono leading-relaxed text-slate-600 bg-white p-3.5 rounded-xl border border-slate-200">
                {generateConfigJson()}
              </pre>
              ...
              <div className="mt-4 pt-3.5 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-3">
                ...
                <Link
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-black hover:bg-slate-800 text-white font-mono font-bold px-4 py-2 text-xs transition-all shadow-md active:scale-95 border border-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900"
                >
        ...
        <section id="integration-code">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            {/* GitHub Action */}
            <div className="rounded-2xl border border-slate-200 bg-white p-5 text-black shadow-md flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-slate-50 hover:bg-slate-100 text-xs font-mono text-slate-600 border border-slate-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900"
                  >
                    {copiedSnippet === 'gh-yaml' ? <Check className="h-3 w-3 text-emerald-600" /> : <Copy className="h-3 w-3" />}
                    <span>{copiedSnippet === 'gh-yaml' ? 'Copied' : 'Copy'}</span>
                  </button>
                </div>
                <pre className="overflow-x-auto text-[11px] font-mono leading-relaxed text-slate-600 bg-white p-3.5 rounded-xl border border-slate-200">
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-slate-50 hover:bg-slate-100 text-xs font-mono text-slate-600 border border-slate-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900"
                  >
                    {copiedSnippet === 'cf-worker' ? <Check className="h-3 w-3 text-emerald-600" /> : <Copy className="h-3 w-3" />}
                    <span>{copiedSnippet === 'cf-worker' ? 'Copied' : 'Copy'}</span>
                  </button>
                </div>
                <pre className="overflow-x-auto text-[11px] font-mono leading-relaxed text-slate-600 bg-white p-3.5 rounded-xl border border-slate-200 max-h-60">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-10 text-black shadow-xl">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="space-y-2 text-center lg:text-left max-w-2xl">
              <div className="inline-flex items-center gap-1.5 rounded-full border border-slate-300 bg-slate-50 px-3 py-1 text-xs font-mono text-slate-800">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0">
              <Link
                to="/pricing"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-black hover:bg-slate-800 text-white font-mono font-bold px-5 py-3 text-xs sm:text-sm transition-all shadow-md active:scale-95 border border-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900"
              >
              ...
              <Link
                to="/contact"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-100 text-slate-600 hover:text-black px-5 py-3 text-xs sm:text-sm font-mono transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900"
              >
