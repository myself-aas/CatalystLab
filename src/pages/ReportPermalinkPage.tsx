...
export const ReportPermalinkPage: React.FC = () => {
 ...
 if (error || !report) {
 return (
 <div className="ds-page-shell[70vh] font-mono">
 ...
 {/* Top Bar Navigation */}
 <section className="border-b border-border bg-muted py-3 sm:px-6 lg:px-8">
 <div className="mx-auto flex max-w-3xl mx-auto items-center justify-between">
 <Link
 to="/dashboard"
 ...
 <button
 onClick={handleCopy}
 className="ds-card flex items-center gap-1.5 text-xs font-medium text-muted-foreground ds-card-interactive p-4"
 ...
 className="ds-card items-center gap-1.5 text-xs font-medium text-muted-foreground ds-card-interactive p-4"
 ...
 className="flex items-center gap-1.5 rounded-lg bg-primary hover:bg-primary-hover border border-border px-2.5 py-1.5 text-xs font-bold text-primary-foreground transition-colors disabled:opacity-50 shadow-sm cursor-pointer"
 ...
 <span className="text-xs uppercase font-bold py-0.5 rounded border bg-amber-50 text-amber-700 border-amber-200">
 {meta.name}
 </span>
 <span className="flex items-center gap-1 rounded bg-accent py-0.5 text-[11px] text-muted-foreground border border-border">
 ...
 className="flex items-center gap-1.5 rounded-xl border border-border bg-accent .5 px-4 py-2 text-xs font-bold text-foreground hover:bg-muted transition-colors"
 >
