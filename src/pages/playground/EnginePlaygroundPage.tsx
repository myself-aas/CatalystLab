...
func main() {
 ...
 <div className="ds-page-shell rounded-2xl bg-background p-6 shadow-2xl space-y-4">
 ...
 <strong className="text-foreground bg-accent py-0.5 rounded">
 ...
 <div className="rounded-xl border border-dashed border-border bg-muted py-2 text-[11px] text-muted-foreground flex items-center justify-between">
 ...
 {statusCode !== null && (
 <span className={`.5 py-1 rounded-lg font-bold ${
 ...
 {responseTimeMs !== null && (
 <span className=".5 py-1 rounded-lg bg-sky-100 text-sky-800 font-bold">
 {responseTimeMs} ms
 </span>
 )}
 </div>
