...
export const DiagnosticEnginesPage: React.FC = () => {
 ...
 <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_40%,rgba(240,250,255,0.04)_0%,transparent_70%)] pointer-events-none" />
 ...
 <Cpu className="h-3.5 w-3.5 text-[#F0FAFF] shrink-0"/>
 ...
 <span className="inline-flex items-center gap-1 rounded-full border border-emerald-500/20 bg-[#F0FAFF]/10 px-3 py-1 framer-micro-tag text-emerald-400">
 Python 3.11 Runtime
 </span>
 </div>
