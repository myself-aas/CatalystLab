  ...
  return (
    <div className="min-h-screen bg-white pb-24 text-black font-mono selection:bg-black selection:text-white">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 text-center text-black shadow-sm space-y-3">
          <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-xl bg-slate-50 border border-slate-200 text-slate-900 shadow-sm">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-2.5">
            ...
            <Link
              to="/security"
              className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-xs font-bold text-black hover:bg-slate-100 transition-all"
            >
