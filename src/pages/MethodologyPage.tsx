...
export const MethodologyPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white text-black font-mono selection:bg-black selection:text-white">
      ...
      {/* Hero Banner */}
      <section className="border-b border-gray-200 bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-4">
          ...
          <p className="max-w-2xl text-xs sm:text-sm text-gray-600 font-sans leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <LazyReveal direction="left" className="space-y-4 font-sans">
            ...
            <div className="pt-2">
              <Link 
                to="/master-audit" 
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-black hover:bg-black-hover border border-brand-periwinkle/30 text-white font-mono text-xs font-bold transition-all shadow-sm group"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 space-y-3">
              ...
              <p className="text-gray-600 leading-relaxed text-xs font-sans">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-gray-600 max-w-xl mx-auto font-sans">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 space-y-2.5">
            <div className="w-9 h-9 rounded-xl bg-gray-100 border border-gray-200 text-accent-amber flex items-center justify-center">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 space-y-2.5">
            <div className="w-9 h-9 rounded-xl bg-gray-100 border border-gray-200 text-accent-emerald flex items-center justify-center">
