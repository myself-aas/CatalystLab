...
export const ApiReferenceDoc: React.FC = () => {
    ...
    >
      <section id="api-overview" className="space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-3 pt-2">
          <Link
            to="/api-docs"
            className="flex items-center gap-1.5 rounded-xl bg-background px-4 py-2 text-xs font-bold text-sky-400 hover:bg-muted transition shadow-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
          ...
          <Link
            to="/playground"
            className="flex items-center gap-1.5 rounded-xl border border-border bg-background px-4 py-2 text-xs font-bold text-foreground hover:bg-background transition shadow-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
  ...
  -d '{"url": "https://example.com", "engine": "website-health"}'`}
      ...
      {/* POST /api/run-engine */}
      <section id="run-engine" className="space-y-4 border-t border-border pt-8">
...
logger.debug("Quality Score:", data.score);`}
      ...
      <section id="monitor-probe" className="space-y-4 border-t border-border pt-8">
        <div className="flex items-center gap-2">
          <span className="rounded-md bg-blue-600 px-2.5 py-1 text-xs font-mono font-bold text-primary-foreground uppercase">
            POST
          </span>
      ...
      <section id="system-health" className="space-y-4 border-t border-border pt-8">
        <div className="flex items-center gap-2">
