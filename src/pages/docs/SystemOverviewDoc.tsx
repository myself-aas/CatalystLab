...
export const SystemOverviewDoc: React.FC = () => {
 ...
 <h1 className="text-4xl sm:text-5xl font-display font-medium text-[#EDEDED]">
 ...
 <h2 className="text-2xl sm:text-3xl font-display font-medium text-[#EDEDED] tracking-normal">
 ...
 <div className="rounded-xl border-l-4 border-primary bg-primary/10 p-5 text-sm text-[#EDEDED]">
 <div className="flex items-start gap-3">
 <Info className="h-5 w-5 text-primary shrink-0 mt-0.5"/>
 <div className="space-y-2">
 <h2 className="font-bold text-[#EDEDED] text-base">Zero Client-Script Execution Model</h2>
 ...
 <h2 className="text-2xl font-display font-medium text-[#EDEDED]">The 8 SDLC Catalysts</h2>
 ...
 <td className="py-2 text-[#A1A1AA]">Platform Migration & System Blueprint</td>
 ...
 <td className="py-2 text-[#A1A1AA]">Git Repository SecOps & Hygiene</td>
 ...
 <td className="py-2 text-[#A1A1AA]">Sustainable Web Carbon Footprint</td>
 ...
 <td className="py-2 text-[#A1A1AA]">Core Web Vitals & DOM Tree Depth</td>
 ...
 <td className="py-2 text-[#A1A1AA]">Multi-PoP Global Edge Latency</td>
 ...
 <td className="py-2 text-[#A1A1AA]">OWASP Security & Compliance</td>
 ...
 <td className="py-2 text-[#A1A1AA]">AI Readiness & llms.txt Discovery</td>
 ...
 <td className="py-2 text-[#A1A1AA]">AI Search Engine Optimization (LLMO)</td>
 ...
 <h2 className="text-2xl font-display font-medium text-[#EDEDED]">Next Steps</h2>
 ...
 >
 <div className="font-bold text-[#EDEDED] group-hover:text-primary flex items-center justify-between">
 <span>Edge Mesh &amp; Webhooks</span>
 <ArrowRight className="h-3.5 w-3.5"/>
 </div>
 <p className="text-xs text-[#A1A1AA] mt-1">Interactive 42-PoP Anycast mesh & webhook fan-out live visualizer.</p>
 </Link>
 ...
 <p className="text-xs text-[#A1A1AA] mt-1">Explore ingress, worker processes & Firestore storage.</p>
 </Link>
 ...
 <p className="text-xs text-[#A1A1AA] mt-1">Programmatic endpoint schemas and execution parameters.</p>
 </Link>
 ...
 <p className="text-xs text-[#A1A1AA] mt-1">Detailed blueprints, calculations, and remediation guides.</p>
 </Link>
 </div>
 </section>
 </DocsLayout>
