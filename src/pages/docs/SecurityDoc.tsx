...
export const SecurityDoc: React.FC = () => {
 ...
 <td className="py-2 text-muted-foreground">Forces HTTPS across all subdomains for 2 years</td>
 </tr>
 <tr>
 ...
 <td className="py-2 text-muted-foreground">Prevents browser MIME-type sniffing exploits</td>
 </tr>
 <tr>
 ...
 <td className="py-2 text-muted-foreground">Blocks malicious clickjacking frames</td>
 </tr>
 <tr>
 ...
 <td className="py-2 text-muted-foreground">Shields user privacy in outgoing referrers</td>
 </tr>
 </tbody>
 </table>
 </div>
