...
export const EcoHoloDoc: React.FC = () => {
 ...
 <div className="inline-flex items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-50 py-0.5 text-xs font-semibold text-emerald-800">
...
export function calculateCarbonEmissions(bytesTransferred: number, isGreenHosted: boolean) {
 ...
 <td className="py-2 text-muted-foreground">Cleaner than 95% of the web</td>
 ...
 <td className="py-2 text-muted-foreground">Cleaner than 85% of the web</td>
 ...
 <td className="py-2 text-muted-foreground">Cleaner than 70% of the web</td>
 ...
 <td className="py-2 text-muted-foreground">Industry standard baseline</td>
