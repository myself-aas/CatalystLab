...
export const RiskProteaseDoc: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* OWASP Compliance */}
      <section id="owasp-compliance" className="space-y-4 border-t border-[#e2e8f0] pt-8">
        <h2 className="text-2xl font-bold text-[#0b192c]">OWASP Security Headers Implementation</h2>
...
app.use(helmet({
  ...
  noSniff: true
      ...
      {/* WCAG Accessibility */}
      <section id="wcag-accessibility" className="space-y-4 border-t border-[#e2e8f0] pt-8">
        <h2 className="text-2xl font-bold text-[#0b192c]">WCAG 2.2 AA Contrast Standards</h2>
        <p className="text-sm text-[#415a77] leading-relaxed">
      ...
      {/* Cookie Consent */}
      <section id="cookie-consent" className="space-y-4 border-t border-[#e2e8f0] pt-8">
        <h2 className="text-2xl font-bold text-[#0b192c]">GDPR / CCPA Consent & Tracker Detection</h2>
        <p className="text-sm text-[#415a77] leading-relaxed">
