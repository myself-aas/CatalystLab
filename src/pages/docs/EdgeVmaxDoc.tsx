...
export const EdgeVmaxDoc: React.FC = () => {
 ...
 <h2 className="text-2xl font-bold text-[#EDEDED]">12 Global Evaluation Points of Presence</h2>
 ...
 <h2 className="text-2xl font-bold text-[#EDEDED]">Synthetic TTFB Timing Breakdown</h2>
 ...
 <td className="py-2 text-[#A1A1AA]">Uncached nameserver or slow recursive resolver</td>
 </tr>
 <tr>
 <td className="py-2 font-semibold">TCP Handshake</td>
 <td className="py-2 font-mono text-emerald-700 font-bold">&lt; 40 ms</td>
 <td className="py-2 text-[#A1A1AA]">Physical distance to origin server (No Anycast)</td>
 </tr>
 <tr>
 <td className="py-2 font-semibold">TLS 1.3 Negotiation</td>
 <td className="py-2 font-mono text-emerald-700 font-bold">&lt; 50 ms</td>
 <td className="py-2 text-[#A1A1AA]">Legacy TLS 1.2 or missing 0-RTT session resumption</td>
 </tr>
 <tr>
 ...
 <td className="py-2 text-[#A1A1AA]">Uncached SSR responses or slow database queries</td>
 </tr>
 </tbody>
 </table>
 </div>
 ...
 <h2 className="text-2xl font-bold text-[#EDEDED]">Cloudflare Edge Worker Cache Recipe</h2>
 <p className="text-sm text-[#A1A1AA] leading-relaxed">
