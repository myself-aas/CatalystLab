...
export const EdgeVmaxDoc: React.FC = () => {
 ...
 <div className="inline-flex items-center gap-1.5 rounded-full border border-pink-200 bg-pink-50 py-0.5 text-xs font-semibold text-pink-800">
 ...
 <td className="py-2 text-muted-foreground">Uncached nameserver or slow recursive resolver</td>
 </tr>
 <tr>
 <td className="py-2 font-semibold">TCP Handshake</td>
 <td className="py-2 font-mono text-emerald-700 font-bold">&lt; 40 ms</td>
 <td className="py-2 text-muted-foreground">Physical distance to origin server (No Anycast)</td>
 </tr>
 <tr>
 <td className="py-2 font-semibold">TLS 1.3 Negotiation</td>
 <td className="py-2 font-mono text-emerald-700 font-bold">&lt; 50 ms</td>
 <td className="py-2 text-muted-foreground">Legacy TLS 1.2 or missing 0-RTT session resumption</td>
 </tr>
 <tr>
 ...
 <td className="py-2 text-muted-foreground">Uncached SSR responses or slow database queries</td>
 </tr>
 </tbody>
 </table>
 </div>
