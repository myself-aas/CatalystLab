...
Please provide the exact collection schemas, indexing commands, and zero-downtime database synchronization scripts.`;
 ...
 <div className="inline-flex items-center gap-1.5 rounded-full border border-orange-200 bg-orange-50 py-0.5 text-xs font-semibold text-orange-800">
...
taskSchema.index({ projectId: 1, status: 1, assigneeId: 1 });`}
 ...
 <div className="ds-card p-4 text-xs font-mono">
 {masterPromptText}
 </div>
 </section>
 </DocsLayout>
