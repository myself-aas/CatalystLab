...
Please provide the exact collection schemas, indexing commands, and zero-downtime database synchronization scripts.`;
  ...
  return (
    ...
    >
      ...
      {/* NoSQL Schema */}
      <section id="nosql-schema" className="space-y-4 border-t border-[#e2e8f0] pt-8">
        <h2 className="text-2xl font-bold text-[#0b192c]">High-Performance MongoDB Schema</h2>
...
taskSchema.index({ projectId: 1, status: 1, assigneeId: 1 });`}
      ...
      {/* Compound Indexes */}
      <section id="compound-indexes" className="space-y-4 border-t border-[#e2e8f0] pt-8">
        <h2 className="text-2xl font-bold text-[#0b192c]">Compound Indexes & Capacity Aggregation</h2>
        <p className="text-sm text-[#415a77] leading-relaxed">
  ...
  { $sort: { totalPoints: -1 } }
      ...
      {/* Master Prompt */}
      <section id="master-prompt" className="space-y-4 border-t border-[#e2e8f0] pt-8">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold text-[#0b192c]">Google AI Studio Master Planning Prompt</h2>
          <button
            onClick={() => {
          ...
          >
            {copiedPrompt ? (
              ...
              <>
                <Copy className="h-3.5 w-3.5 text-[#415a77]" />
        ...
        <div className="rounded-xl border border-[#e2e8f0] bg-[#f8fafc] p-4 text-xs font-mono text-[#0b192c] leading-relaxed">
          {masterPromptText}
        </div>
      </section>
    </DocsLayout>
