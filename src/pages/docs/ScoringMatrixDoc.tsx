...
export const ScoringMatrixDoc: React.FC = () => {
 ...
 <div className="bg-background p-3.5 rounded-lg border border-border text-sm font-semibold text-[#EDEDED] leading-relaxed">
 ...
 <h2 className="text-2xl font-bold text-[#EDEDED]">Evaluation Vector Weights</h2>
 ...
 <td className="py-2.5 text-[#A1A1AA]">&le; 32 levels, &lt; 800 nodes</td>
 ...
 <td className="py-2.5 text-[#A1A1AA]">&lt; 350 ms across 12 PoPs</td>
 <td className="py-2.5 font-mono font-bold">20%</td>
 ...
 <td className="py-2.5 text-[#A1A1AA]">llms.txt + JSON-LD Schemas</td>
 ...
 <td className="py-2.5 text-[#A1A1AA]">HSTS, CSP, X-Frame, TLS 1.3</td>
 <td className="py-2.5 font-mono font-bold">15%</td>
 ...
 <td className="py-2.5 text-[#A1A1AA]">AA Contrast & ARIA Labels</td>
 <td className="py-2.5 font-mono font-bold">15%</td>
 ...
 <td className="py-2.5 text-[#A1A1AA]">&lt; 0.25g CO2 / Page Load</td>
 <td className="py-2.5 font-mono font-bold">15%</td>
 ...
 <h2 className="text-2xl font-bold text-[#EDEDED]">Penalty Deduction Table</h2>
 ...
 <td className="py-2 text-[#A1A1AA]">Medium (Bandwidth waste)</td>
 </tr>
 <tr>
 <td className="py-2 font-semibold text-amber-700">Synchronous Render-Blocking Head Scripts</td>
 <td className="py-2 font-mono font-bold text-amber-700">-10 pts</td>
 <td className="py-2 text-[#A1A1AA]">Medium (LCP degradation)</td>
 </tr>
 </tbody>
 </table>
 </div>
 ...
 <h2 className="text-2xl font-bold text-[#EDEDED]">Grade Classification Tiers</h2>
 <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 text-sm">
 <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-4 text-center">
 <div className="text-2xl font-black text-emerald-700">90 – 100</div>
 <div className="font-bold text-[#EDEDED] mt-1">Grade A (Pristine)</div>
 <p className="text-xs text-[#A1A1AA] mt-1">Production Ready & Elite</p>
 </div>
 ...
 <div className="font-bold text-[#EDEDED] mt-1">Grade B (Good)</div>
 <p className="text-xs text-[#A1A1AA] mt-1">Minor Optimizations</p>
 </div>

 <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-4 text-center">
 <div className="text-2xl font-black text-amber-700">60 – 74</div>
 <div className="font-bold text-[#EDEDED] mt-1">Grade C (Moderate)</div>
 <p className="text-xs text-[#A1A1AA] mt-1">Latency or DOM Bottlenecks</p>
 </div>
 ...
 <div className="font-bold text-[#EDEDED] mt-1">Grade F (Deficient)</div>
 <p className="text-xs text-[#A1A1AA] mt-1">Critical Security & INP Issues</p>
 </div>
 </div>
 </section>
 </DocsLayout>
