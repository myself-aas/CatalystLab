...
export const ScoringMatrixDoc: React.FC = () => {
 ...
 <td className="py-2.5 text-foreground-muted">&le; 32 levels, &lt; 800 nodes</td>
 ...
 <td className="py-2.5 text-foreground-muted">&lt; 350 ms across 12 PoPs</td>
 <td className="py-2.5 font-mono font-bold">20%</td>
 ...
 <td className="py-2.5 text-foreground-muted">llms.txt + JSON-LD Schemas</td>
 ...
 <td className="py-2.5 text-foreground-muted">HSTS, CSP, X-Frame, TLS 1.3</td>
 <td className="py-2.5 font-mono font-bold">15%</td>
 ...
 <td className="py-2.5 text-foreground-muted">AA Contrast & ARIA Labels</td>
 <td className="py-2.5 font-mono font-bold">15%</td>
 ...
 <td className="py-2.5 text-foreground-muted">&lt; 0.25g CO2 / Page Load</td>
 <td className="py-2.5 font-mono font-bold">15%</td>
 ...
 <td className="py-2 text-foreground-muted">Medium (Bandwidth waste)</td>
 </tr>
 <tr>
 <td className="py-2 font-semibold text-amber-700">Synchronous Render-Blocking Head Scripts</td>
 <td className="py-2 font-mono font-bold text-amber-700">-10 pts</td>
 <td className="py-2 text-foreground-muted">Medium (LCP degradation)</td>
 </tr>
 </tbody>
 </table>
 </div>
