          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-white/[0.06] text-foreground">
              ...
              <tr>
                ...
                <td className="py-2.5 px-3 text-muted-foreground">&lt; 350 ms across 12 PoPs</td>
                <td className="py-2.5 px-3 font-mono font-bold">20%</td>
              ...
              <tr>
                ...
                <td className="py-2.5 px-3 text-muted-foreground">HSTS, CSP, X-Frame, TLS 1.3</td>
                <td className="py-2.5 px-3 font-mono font-bold">15%</td>
              ...
              <tr>
                ...
                <td className="py-2.5 px-3 text-muted-foreground">AA Contrast & ARIA Labels</td>
                <td className="py-2.5 px-3 font-mono font-bold">15%</td>
              ...
              <tr>
                ...
                <td className="py-2.5 px-3 text-muted-foreground">&lt; 0.25g CO2 / Page Load</td>
                <td className="py-2.5 px-3 font-mono font-bold">15%</td>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-white/[0.06] text-foreground">
              ...
              <tr>
                ...
                <td className="py-2 px-3 text-muted-foreground">Medium (Bandwidth waste)</td>
              </tr>
              <tr>
                <td className="py-2 px-3 font-semibold text-amber-700">Synchronous Render-Blocking Head Scripts</td>
                <td className="py-2 px-3 font-mono font-bold text-amber-700">-10 pts</td>
                <td className="py-2 px-3 text-muted-foreground">Medium (LCP degradation)</td>
              </tr>
            </tbody>
          </table>
        </div>
