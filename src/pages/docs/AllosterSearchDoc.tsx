...
export const AllosterSearchDoc: React.FC = () => {
 ...
 <div className="inline-flex items-center gap-1.5 rounded-full border border-indigo-200 bg-indigo-50 py-0.5 text-xs font-semibold text-indigo-800">
 ...
 <h2 className="text-2xl font-bold text-foreground">RAG Extractability & Factual Density</h2>
 ...
 <h2 className="text-2xl font-bold text-foreground">Semantic Heading Hierarchy Guidelines</h2>
 <p className="text-sm text-muted-foreground leading-relaxed">
 ...
 <h2 className="text-2xl font-bold text-foreground">E-E-A-T Author & Citation Verification</h2>
 <p className="text-sm text-muted-foreground leading-relaxed">
