        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="rounded-2xl border border-emerald-500/30 bg-emerald-50/70 p-4 shrink-0 shadow-xs">
              ...
              <div className="mt-1 text-xs text-emerald-950 font-semibold">
          ...
          <div className="rounded-3xl border border-[#e2e8f0] bg-white p-6 sm:p-9 shadow-sm">
            {submitted ? (
              <div className="rounded-3xl border border-emerald-500/40 bg-emerald-50 p-8 sm:p-10 text-center space-y-4">
                ...
                <div className="inline-block rounded-xl border border-emerald-500/30 bg-white px-4 py-1.5 font-mono text-sm font-bold text-emerald-800">
                ...
                <button
                  ...
                  className="mt-4 rounded-xl bg-[#0b192c] px-6 py-2.5 text-xs font-bold text-white hover:bg-[#152238] transition-all shadow-md active:scale-98"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  <label className="block text-xs font-extrabold text-[#0b192c] uppercase tracking-wider mb-3">
                ...
                {/* 2. Priority Level */}
                <div>
                  <label className="block text-xs font-extrabold text-[#0b192c] uppercase tracking-wider mb-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-[#e2e8f0] bg-[#f8fafc] px-3.5 py-2.5 text-xs text-[#0b192c] focus:border-[#415a77] focus:outline-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-[#e2e8f0] bg-[#f8fafc] px-3.5 py-2.5 text-xs text-[#0b192c] focus:border-[#415a77] focus:outline-none font-mono"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-[#e2e8f0] bg-[#f8fafc] p-3.5 text-xs text-[#0b192c] focus:border-[#415a77] focus:outline-none"
                  />
                </div>

                {/* 6. Diagnostics Checkbox */}
                <div className="rounded-2xl border border-[#e2e8f0] bg-[#f8fafc] p-4 flex items-start gap-3 text-xs text-[#415a77]">
                  <input
                    type="checkbox"
                    id="attach-diag"
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 rounded-xl bg-[#0b192c] py-4 text-xs font-bold text-white hover:bg-[#152238] transition-all shadow-md active:scale-98"
                >
        ...
        <LazyReveal direction="up">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="rounded-3xl border border-[#415a77]/30 bg-[#0b192c] p-6 text-[#f8fafc] shadow-xl space-y-2">
              ...
              <h4 className="text-sm font-bold text-white">Direct Email Hotline</h4>
              <p className="text-xs text-[#94a3b8]">support@catalystlab.tech</p>
            </div>
            ...
            <div className="rounded-3xl border border-[#415a77]/30 bg-[#0b192c] p-6 text-[#f8fafc] shadow-xl space-y-2">
              ...
              <h4 className="text-sm font-bold text-white">Superadmin Studio</h4>
              <p className="text-xs text-[#94a3b8]">Admin Live Console (/admin)</p>
            </div>
            ...
            <div className="rounded-3xl border border-[#415a77]/30 bg-[#0b192c] p-6 text-[#f8fafc] shadow-xl space-y-2">
              ...
              <h4 className="text-sm font-bold text-white">Security Vulnerabilities</h4>
              <p className="text-xs text-[#94a3b8]">security@catalystlab.tech</p>
            </div>
          </div>
        </LazyReveal>
