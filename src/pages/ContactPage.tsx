        ...
        <div className="relative z-10 w-full px-4 sm:px-8 lg:px-12">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="space-y-4">
              ...
              <p className="text-sm sm:text-base text-muted-foreground max-w-2xl leading-relaxed font-sans font-normal">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8 space-y-10">
          ...
          <div className="rounded-2xl border border-border bg-background p-6 sm:p-8 shadow-sm">
            {submitted ? (
              <div className="rounded-2xl border border-emerald-200 bg-emerald-50/50 p-8 text-center space-y-4">
                <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-600 text-primary-foreground shadow-sm">
                  <CheckCircle2 className="h-7 w-7" />
                </div>
                <h2 className="text-xl font-extrabold text-foreground">Support Ticket Generated</h2>
                <div className="inline-block rounded-xl border border-emerald-200 bg-background px-4 py-1.5 text-sm font-mono font-bold text-emerald-800 shadow-sm">
                ...
                <button
                  ...
                  className="mt-2 rounded-xl bg-primary hover:bg-primary-hover px-6 py-2.5 text-xs font-bold text-primary-foreground shadow-sm cursor-pointer transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6 font-sans">
                ...
                <div>
                  <label className="block text-xs font-mono font-bold text-foreground uppercase tracking-wider mb-2.5">
                      ...
                      return (
                        ...
                        >
                          <div className={`p-2 rounded-xl shrink-0 border ${
                            isSelected ? 'bg-primary text-primary-foreground border-border' : 'bg-accent text-muted-foreground border-border'
                          }`}>
                            <Icon className="h-4 w-4" />
                          </div>
                          <div>
                            <div className="font-bold text-xs font-sans text-foreground">{dep.label}</div>
                            <div className="text-[11px] mt-0.5 leading-relaxed font-sans text-muted-foreground">
                              {dep.desc}
                            </div>
                          </div>
                        </button>
                ...
                {/* 2. Priority Level */}
                <div>
                  <label className="block text-xs font-mono font-bold text-foreground uppercase tracking-wider mb-2">
                ...
                <div className="rounded-xl border border-border bg-muted p-4 flex items-start gap-3 text-xs text-muted-foreground font-sans">
                  <input
                    type="checkbox"
                    id="attach-diag"
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 rounded-xl bg-primary hover:bg-primary-hover py-3.5 text-xs font-bold text-primary-foreground shadow-sm active:scale-[0.98] disabled:opacity-60 cursor-pointer transition-colors"
                >
                  {isSubmitting ? (
                    <>
        ...
        <LazyReveal direction="up">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="rounded-2xl border border-border bg-background p-5 shadow-sm space-y-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-accent text-muted-foreground border border-border mb-2">
                <Mail className="h-4 w-4" />
              </div>
              <h4 className="text-xs font-bold text-foreground font-sans">Direct Email Hotline</h4>
              <p className="text-xs text-muted-foreground font-mono">support@catalystlab.tech</p>
            </div>
            ...
            <div className="rounded-2xl border border-border bg-background p-5 shadow-sm space-y-2">
              ...
              <h4 className="text-xs font-bold text-foreground font-sans">Superadmin Studio</h4>
            ...
            <div className="rounded-2xl border border-border bg-background p-5 shadow-sm space-y-2">
              ...
              <h4 className="text-xs font-bold text-foreground font-sans">Security Vulnerabilities</h4>
              <p className="text-xs text-muted-foreground font-mono">security@catalystlab.tech</p>
            </div>
          </div>
        </LazyReveal>
