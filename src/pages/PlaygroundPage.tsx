...
func main() {
 ...
 className={`flex items-center gap-2 rounded-xl py-1.5 text-xs font-bold whitespace-nowrap transition-all border shrink-0 cursor-pointer ${
 isSelected
 ...
 <div className="ds-card p-4 shadow-xl space-y-3.5">
 ...
 className={` py-0.5 text-xs font-bold rounded transition-colors cursor-pointer ${
 builderMode === 'visual'
 ...
 className={`rounded-lg border .5 py-1 text-[11px] text-center transition-colors cursor-pointer ${
 active
 ...
 <div className="ds-card flex items-center p-2.5">
 <div>
 ...
 <div className="ds-card shadow-xl flex flex-col p-4">
 
 {/* Response Inspector Tab Header */}
 <div className="border-b border-border bg-muted py-2.5 flex flex-wrap items-center justify-between gap-3">
 <div className="flex items-center gap-2">
 ...
 className={`px-3.5 py-1 text-xs font-bold rounded-lg transition-colors capitalize cursor-pointer ${
 inspectorTab === tab
 ? 'bg-primary text-primary-foreground shadow-xs'
 ...
 <tr>
 <th className=".5 py-2">Header Name</th>
 <th className=".5 py-2">Value</th>
 </tr>
 </thead>
 ...
 <td className="px-2.5 py-1.5 text-foreground font-semibold">{key}</td>
 <td className="px-2.5 py-1.5 text-foreground break-all">{val}</td>
 </tr>
 ))
 ) : (
 <tr>
 <td colSpan={2} className=".5 py-3 text-center text-muted-foreground">
 ...
 className={` py-0.5 text-xs font-bold uppercase rounded transition-colors cursor-pointer ${
