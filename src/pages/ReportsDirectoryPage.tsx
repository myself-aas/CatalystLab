      ...
      <section className="border-b border-gray-200 bg-gray-100 px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <div className="inline-flex items-center gap-1.5 rounded-full border border-gray-200 bg-white px-3 py-1 text-xs font-bold text-accent-amber-strong uppercase tracking-wider mb-3">
          ...
          <form onSubmit={handleInstantInspect} className="mt-3">
            <div className="flex flex-col sm:flex-row gap-2 rounded-xl border border-gray-200 bg-white p-2 shadow-xl">
              ...
              >
                ...
                <ArrowRight className="h-3 w-3 text-accent-amber-strong" />
              </button>
            </div>
          </form>
        </div>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8 space-y-8">
          ...
          <section className="space-y-3.5">
            <div className="flex items-center justify-between">
              <h2 className="text-xs font-bold text-black uppercase tracking-wider flex items-center gap-1.5">
                <span className="flex h-5 w-5 items-center justify-center rounded bg-gray-100 text-accent-amber-strong text-xs">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between gap-2 mb-2.5">
                      <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-gray-100 text-accent-amber-strong border border-gray-200">
                        <Activity className="h-3.5 w-3.5" />
                      </span>
                      <span className="text-[10px] uppercase font-bold text-accent-amber-strong bg-gray-100 px-2 py-0.5 rounded border border-gray-200">
                        {meta.name}
                      </span>
                    </div>

                    <div className="font-bold text-xs text-black group-hover:text-accent-amber-strong transition-colors truncate">
                      {domainName}
                    </div>
            ...
            {filteredFeatured.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-2.5 mt-3 border-t border-gray-200 text-[11px] text-gray-500">
                    <span className="text-accent-amber-strong font-bold">{item.score}/100 Score</span>
                    <span className="flex items-center gap-1 font-bold text-gray-500 group-hover:text-white transition-colors">
        ...
        {!user && (
          <div className="rounded-2xl border border-gray-200 bg-white p-6 sm:p-8 text-center shadow-xl text-black">
            <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-xl bg-gray-100 border border-gray-200 text-accent-amber-strong mb-2.5 shadow-sm">
