...
export const FullscreenCard: React.FC<FullscreenCardProps> = ({
  ...
  // Smooth springs for fluid, organic physics
  ...
  // Smooth hover progress for elevation on Z-axis
  ...
  // Parallax Layer Depths & 3D Tilt Rotations:
  // 1. Background image counter-shift (optical background depth)
  ...
  // 2. Badge Element 3D Tilt & Z-Depth (Floating Top Plane)
  ...
  // 3. Title Element 3D Tilt & Z-Depth (Primary Focal Plane)
  ...
  // 4. Subtitle, Metric & Description 3D Tilt & Z-Depth
  ...
  // 5. Footer & Action 3D Tilt & Z-Depth
  ...
  return (
    <div style={{ perspective: 1200 }} className="w-full">
      ...
      >
        {/* 1. Fullscreen Background Image with Framer Motion hover scale and counter-parallax */}
        <motion.div
        ...
        {/* 2. Dynamic Gradient & Glassmorphism Overlay with Dark Gradient Scrim */}
        <div
          aria-hidden="true"
        ...
        {/* 3. Foreground Content with Multi-Planar Parallax Elements & Dark Gradient Scrim */}
        <div
        ...
        >
          {/* Top Header Row with High-Z Parallax Badge */}
          ...
          {/* Middle Content Section with Parallax Title & Depth Typography */}
