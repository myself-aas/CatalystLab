        ...
        <div className="flex-1 bg-black/[0.02] dark:bg-white/[0.02] flex flex-col min-w-0 transition-all duration-300">
           ...
           <div className="p-6 md:p-8 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
               <div className="h-36 bg-card rounded-xl border border-border/50 shadow-sm overflow-hidden flex flex-col justify-between p-4 relative group">
                 <img 
                 ...
                 <div className="relative z-10">
                   <span className="text-[11px] font-mono text-primary uppercase tracking-wider font-semibold">Active Engine Telemetry</span>
                   <h4 className="text-sm font-medium text-foreground mt-1">Live PoP Latency Matrix</h4>
                 </div>
                 <div className="relative z-10 flex items-center justify-between text-xs text-muted-foreground font-mono">
                   <span>38 Global Nodes</span>
               ...
               <div className="h-36 bg-card rounded-xl border border-border/50 shadow-sm overflow-hidden flex flex-col justify-between p-4 relative group">
                 <img 
                   ...
                   alt="Synthetic Web Vitals" 
                   className="absolute inset-0 w-full h-full object-cover opacity-20 group-hover:opacity-30 transition-opacity" 
                   referrerPolicy="no-referrer"
                 />
                 <div className="relative z-10">
                   <span className="text-[11px] font-mono text-primary uppercase tracking-wider font-semibold">Core Web Vitals</span>
                   <h4 className="text-sm font-medium text-foreground mt-1">Autonomous P95 Dossier</h4>
                 </div>
                 <div className="relative z-10 flex items-center justify-between text-xs text-muted-foreground font-mono">
                   <span>P95 LCP 720ms</span>
                   <span className="text-primary font-semibold">Score 98/100</span>
                 </div>
               </div>
             </div>
...
export { SidebarNavPreview, SidebarNavPreview as DashboardSidebarDemo };
