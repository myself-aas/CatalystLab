...
const AUDIT_DIMENSIONS_CONFIG = [
  ...
  { key: 'mobile', name: 'Mobile & Touch', icon: 'smartphone', desc: 'Viewport meta, touch targets & responsiveness' },
  { key: 'accessibility', name: 'Accessibility (WCAG)', icon: 'accessibility', desc: 'Alt text, ARIA landmarks, contrast & labels' },
  { key: 'social', name: 'Social Graph & OG', icon: 'public', desc: 'Open Graph, Twitter cards & preview metadata' },
  { key: 'ethical', name: 'Digital Ethics & Green', icon: 'eco', desc: 'Carbon footprint, sustainability & trackers' },
...
function buildEmailSummaryText(report, options = {}) {
  ...
  summary += `Generated with CatalystLab Telemetry Diagnostic Engine.\n`;
