...
new_gradients = """      {/* Gradient Overlay */}
      ...
      <div className={`absolute inset-x-0 bottom-0 h-[70%] bg-gradient-to-t ${gradientFrom} via-${gradientFrom}/80 to-transparent opacity-95`} />
