...
start_str = "            {filteredTestimonials.map((t) => ("
end_str = "            ))}          </div>"
...
if idx_start != -1 and idx_end != -1:
    new_content = content[:idx_start + len(start_str)] + new_card + "            " + content[idx_end:]
    
    # We also need to add bgImageUrl to testimonials data
    ...
    # And we need to import HeroImageCard
    ...
    print("Testimonials replace failed")
